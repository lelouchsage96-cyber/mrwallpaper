...
test("preferHtmlAccept prefixes JSON-only Accept so Start will not 500", () => {
  assert.equal(preferHtmlAccept("application/json"), "text/html,application/json");
  assert.equal(preferHtmlAccept("application/json, text/plain"), "text/html,application/json, text/plain");
  assert.equal(preferHtmlAccept("text/html"), "text/html");
  assert.equal(preferHtmlAccept("*/*"), "*/*");
  assert.equal(preferHtmlAccept("text/html,application/json"), "text/html,application/json");
  assert.equal(preferHtmlAccept(""), "");
});
