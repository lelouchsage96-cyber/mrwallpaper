import { c as __exportAll, o as getRequest } from "./ssr.mjs";
import { O as getPglite, g as ensureDbReady } from "./queries-bIh47-yB.mjs";
import { $ as encode, $t as isProduction, A as jwtVerify, At as ATTR_CONTEXT, Bt as getBetterAuthVersion, C as serializeSignedCookie, D as decodeJwt, E as base64Url, Ft as getAuthTables, Gt as createLogger, Ht as initGetFieldName, It as getCurrentAdapter, Kt as logger, Lt as queueAfterTransactionHook, Mt as ATTR_OPERATION_ID, Nt as import_src, O as decodeProtectedHeader, Pt as safeJSONParse, Qt as isDevelopment, Rt as runWithAdapter, S as serializeCookie, St as betterFetch, Tt as normalizePathname, Ut as generateId, Vt as initGetModelName, Wt as createRandomStringGenerator, Yt as env, _ as runWithRequestState, _n as optional, a as createAuthorizationURL, b as createRouter$1, c as createRateLimitKey, d as deprecate, dn as boolean, dt as JWTExpired, en as isTest, f as createAuthEndpoint, fn as email, g as hasRequestState, gn as object, h as defineRequestState, hn as number, i as refreshAccessToken, in as BASE_ERROR_CODES, jt as ATTR_HOOK_TYPE, k as importJWK, kt as withSpan, l as findInvalidTrustedProxies, ln as any, m as isAPIError, mn as looseObject, n as socialProviders, nn as BetterAuthError, o as applyDefaultAccessTokenExpiry, p as createAuthMiddleware, qt as shouldPublishLog, r as validateAuthorizationCode, rn as kAPIErrorHeaderSymbol, s as isLoopbackHost, t as SocialProviderListEnum, tn as APIError, u as getIp, un as array, v as getCurrentAuthContext, vn as record, w as filterOutputFields, x as toResponse, y as runWithEndpointContext, yn as string, zt as runWithTransaction } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/verify.server-DYWA13FN.js
...
async function getSessionUser(bearerToken) {
	try {
		...
		try {
			...
			console.error("[auth] getRequest", err);
			return null;
		}
		...
		console.error("[auth] getSessionUser", err);
		return null;
	}
}
/**
...
//#endregion
export { GROK_PROVIDERS as i, verify_server_exports as n, auth as r, requireUserId as t };
