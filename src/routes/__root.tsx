...
export const Route = createRootRoute({
  ...
  head: ({ loaderData }) => {
    ...
    const meta = [
      ...
      { name: "msapplication-TileImage", content: "/icon-192.png?v=16" },
    ...
    return {
      ...
      scripts,
      links: [
        { rel: "icon", type: "image/x-icon", href: "/favicon.ico?v=16" },
        { rel: "shortcut icon", type: "image/x-icon", href: "/favicon.ico?v=16" },
        { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32.png?v=16" },
        ...
        { rel: "manifest", href: "/manifest.webmanifest?v=16" },
...
(function(){
  try {
    ...
    if ('serviceWorker' in navigator) navigator.serviceWorker.register('/sw.js?v=23', { scope: '/', updateViaCache: 'none' }).catch(function(){});
  } catch (error) {}
})();`;
