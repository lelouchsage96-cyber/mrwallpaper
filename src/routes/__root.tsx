...
export const Route = createRootRoute({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      scripts,
      links: [
        { rel: "icon", type: "image/x-icon", href: "/favicon-v6.ico?v=6" },
        { rel: "icon", type: "image/png", sizes: "16x16", href: "/icons/v6/favicon-16.png?v=6" },
        { rel: "icon", type: "image/png", sizes: "32x32", href: "/icons/v6/favicon-32.png?v=6" },
        { rel: "icon", type: "image/png", sizes: "48x48", href: "/icons/v6/favicon-48.png?v=6" },
        { rel: "shortcut icon", href: "/favicon-v6.ico?v=6" },
