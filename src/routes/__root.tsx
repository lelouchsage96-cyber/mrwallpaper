...
export const Route = createRootRoute({
  ...
  head: ({ loaderData }) => {
    ...
    const meta = [
      ...
      { name: "application-name", content: "MrWallpaper" },
      { name: "p:domain_verify", content: "32373938e8bff82b92f68399186a6b17" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "MrWallpaper" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "msapplication-config", content: "/browserconfig.xml" },
      { name: "msapplication-TileColor", content: "#0a0a0b" },
      { name: "msapplication-TileImage", content: "/icon-192.png?v=17" },
    ...
    return {
      ...
      scripts,
      links: [
        { rel: "icon", type: "image/x-icon", href: "/favicon.ico?v=17" },
        { rel: "shortcut icon", type: "image/x-icon", href: "/favicon.ico?v=17" },
        { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32.png?v=17" },
        { rel: "apple-touch-icon", type: "image/png", sizes: "180x180", href: "/apple-touch-icon.png?v=17" },
        { rel: "apple-touch-icon-precomposed", type: "image/png", sizes: "180x180", href: "/apple-touch-icon.png?v=17" },
        { rel: "stylesheet", href: appCss },
        { rel: "manifest", href: "/manifest.webmanifest?v=17" },
...
(function(){
  try {
    ...
    if ('serviceWorker' in navigator) navigator.serviceWorker.register('/sw.js?v=24', { scope: '/', updateViaCache: 'none' }).catch(function(){});
  } catch (error) {}
})();`;
