...
export const Route = createRootRoute({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      scripts,
      links: [
        { rel: "icon", type: "image/png", sizes: "16x16", href: "/icons/v7/favicon-16.png?v=7" },
        { rel: "icon", type: "image/png", sizes: "32x32", href: "/icons/v7/favicon-32.png?v=7" },
        { rel: "shortcut icon", type: "image/png", href: "/icons/v7/favicon-32.png?v=7" },
