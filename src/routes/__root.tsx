  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      links: [
        ...
        { rel: "apple-touch-icon", type: "image/png", sizes: "180x180", href: "/apple-touch-icon-v17.png" },
        { rel: "apple-touch-icon-precomposed", type: "image/png", sizes: "180x180", href: "/apple-touch-icon-v17.png" },
