...
export const Route = createRootRoute({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      scripts,
      links: [
        { rel: "icon", type: "image/x-icon", href: "/favicon.ico?v=8" },
        { rel: "shortcut icon", type: "image/x-icon", href: "/favicon.ico?v=8" },
        { rel: "icon", type: "image/png", sizes: "512x512", href: "/app-icon.png?v=8" },
