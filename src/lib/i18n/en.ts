export const t = {
  ...
  profile: {
    ...
    deleteConfirm: "Permanently delete your Mr Wallpapers account?",
    deleteHint: "Your account, favorites, downloads, notifications, preferences, and other personal app data will be removed. Published wallpapers may remain, but they will no longer be linked to your account. We’ll email you a confirmation link before deletion.",
